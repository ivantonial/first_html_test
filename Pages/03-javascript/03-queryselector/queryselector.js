...
// document.querySelector(".pinkFloydDiscriptionP5").innerHTML = "A segunda etapa tem início com a chegada do guitarrista e vocalista David Gilmour assumindo o posto de Barrett. Ela vai de 1968 a 1972, época de discos mais experimentais, que não vendem muito mas ajudam a criar uma boa reputação e dar uma base de fãs para o grupo.";
// document.querySelector(".pinkFloydDiscriptionP6").innerHTML = "Esse período é marcado também por uma certa democracia, com o baixista Roger Waters, Gilmour, o tecladista Rick Wright e mesmo o baterista Nick Mason escrevendo as canções.";
// document.querySelector(".pinkFloydDiscriptionP7").innerHTML = "Com o lançamento de 'The Dark Side Of The Moon' em 1973 essa formação do Pink Floyd atinge sua plenitude artística e comercial. Os quatro finalmente encontram o seu som que segue aberto a experimentações, mas é bem mais acessível e - como logo se veria - universal.";
// document.querySelector(".pinkFloydDiscriptionP8").innerHTML = "É também a partir desse ponto que Waters vai assumindo mais e mais o controle. Progressivamente ele passará a compor quase tudo sozinho e a se responsabilizar pelos conceitos dos discos e shows e os demais aspectos que envolvem o Floyd.";
// document.querySelector(".pinkFloydDiscriptionP9").innerHTML = "Os outros integrantes tornam-se cada vez mais coadjuvantes - ainda que as colaborações do baixista com Gilmour não possam ser menosprezadas - vide 'Wish You Were Here' ou 'Comfortably Numb'.";
// document.querySelector(".pinkFloydDiscriptionP10").innerHTML = "Em 1983, época de 'The Final Cut', a banda já estava se arrastando. Waters disse que aquele era o fim e não acreditou quando Gilmour falou que seguiria em frente.";
// document.querySelector(".pinkFloydDiscriptionP11").innerHTML = "Mas foi isso o que se sucedeu. Em 1987, para o desespero do baixista, Gilmour, Mason e Wright - retornando depois de ter sido expulso em 1979 - estavam com um novo disco no mercado e uma turnê que lotava arenas e estádios mundo afora.";
// document.querySelector(".pinkFloydDiscriptionP12").innerHTML = "Uma grande briga foi travada nos tribunais e muitas farpas trocadas pela imprensa, mas Gilmour acabou ganhando o direito do uso do nome da banda - como consolação Waters ganhou o direito sobre a marca 'The Wall'.";
// document.querySelector(".pinkFloydDiscriptionP13").innerHTML = "A versão da banda liderada pelo guitarrista era bem mais relaxada e pop que aquela do baixista. Ainda que alguns fãs e críticos tenham torcido o nariz, passados alguns anos, os méritos dessa fase agora são visíveis.";
// document.querySelector(".pinkFloydDiscriptionP14").innerHTML = "Depois de 'The Division Bell' (1994) e a sua turnê, Gilmour deixou a banda para trás.";
// document.querySelector(".pinkFloydDiscriptionP15").innerHTML = "Em 2005, a formação clássica do Floyd se reuniu para tocar no festival Live 8 e tudo indicava que aquele seria o ponto final da banda";
// document.querySelector(".pinkFloydDiscriptionP16").innerHTML = "No ano seguinte, Gilmour lançou seu terceiro disco solo - o primeiro em 22 anos - e mais anos de silêncio se seguiram. Até que em 2014, um novo álbum do Floyd foi anunciado. Na verdade 'The Endless River' era um disco basicamente instrumental construído a partir das sobras de 'The Division Bell  e feito como forma de se homenagear Rick Wright, morto em 2008. O guitarrista disse que a banda não iria sair em turnê e que aquele era o disco de despedida do grupo.";
// document.querySelector(".pinkFloydDiscriptionP17").innerHTML = "Ao que tudo indica, ele não estava brincando. Este ano ele retomou sua carreira solo - com 'Rattle That Lock', seu quarto disco, e anunciou uma grande turnê. Turnê essa que chega agora ao Brasil e marca a primeira apresentação do músico no país - ao contrario de Roger Waters que esteve aqui em três ocasiões (2002, 2007 e 2012).";
// document.querySelector(".pinkFloydDiscriptionP18").innerHTML = "Para marcar esse momento, o Vagalume publica esse especial onde falamos um pouco sobre cada um dos 15 álbuns lançados pelo Pink Floyd.";
